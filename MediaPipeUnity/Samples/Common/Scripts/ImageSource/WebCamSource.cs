...
namespace Mediapipe.Unity
{
  public class WebCamSource : ImageSource
  {
    ...
    private enum AvailableSourcesType
    {
      RearLens,
      FrontLens
    }
    [SerializeField] private AvailableSourcesType _availableSourcesType;
...
#pragma warning restore IDE0025
    ...
    private IEnumerator Start()
    {
      ...
      if (availableSources != null && availableSources.Length > (int)_availableSourcesType)
      {
        webCamDevice = availableSources[(int)_availableSourcesType];
      }
      else if (availableSources != null && availableSources.Length > 0)
      {
