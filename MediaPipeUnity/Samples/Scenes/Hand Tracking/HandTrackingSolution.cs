...
namespace Mediapipe.Unity.HandTracking
{
  public class HandTrackingSolution : ImageSourceSolution<HandTrackingGraph>
  {
    ...
    [SerializeField] private HandWorldLandmarkListAnnotationController _handWorldLandmarkListAnnotationController;
    [SerializeField] private GestureTrackingDirector _gestureTrackingDirector;
    ...
    protected override void OnStartRun()
    {
      if (!runningMode.IsSynchronous())
      {
        ...
        graphRunner.OnHandLandmarksOutput += _gestureTrackingDirector.OnHandLandmarksOutputs;
        // TODO: render HandWorldLandmarks annotations
        graphRunner.OnHandWorldLandmarksOutput += OnPoseWorldLandmarksOutput;
      ...
      SetupAnnotationController(_handWorldLandmarkListAnnotationController, imageSource, true);
    }
    ...
    protected override IEnumerator WaitForNextValue()
    {
      ...
      _handWorldLandmarkListAnnotationController.DrawNow(handWorldLandmarks);
      // TODO: render HandWorldLandmarks annotations
    ...
    private void OnPoseWorldLandmarksOutput(object stream, OutputEventArgs<List<LandmarkList>> eventArgs)
    {
      _handWorldLandmarkListAnnotationController.DrawLater(eventArgs.value);
    }
